...
class Application:
    ...
    # Criação da tela do menu principal
...
# Função para a chamada da aplicação
def main():
    root = Tk()
    Application(root)
    root.mainloop()

# Criado para termos certeza que o programa vai ser executado primeiro
